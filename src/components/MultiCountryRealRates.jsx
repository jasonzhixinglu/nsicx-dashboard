...
function AccordionSection({ title, isOpen, onToggle, children }) {
  return (
    <div style={{ borderLeftStyle: 'solid', borderLeftWidth: '4px', borderLeftColor: isOpen ? 'rgb(99 102 241)' : 'transparent' }}>
      <button
        type="button"
        onClick={onToggle}
        disabled={isOpen}
    ...
    <div className="space-y-3 py-2">
      <ul className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed list-disc pl-5 space-y-1.5 marker:text-indigo-500">
        ...
        <li>
          ...
          {' '}Available for 13 economies, omitting Brazil, Mexico, Russia, and Turkey.
        </li>
      </ul>
